...
// MARK: - LocalContactAPIType

protocol LocalContactAPIType {
...
// MARK: - LocalContactAPI

final class LocalContactAPI: LocalContactAPIType {
    static let `default` = LocalContactAPI()
